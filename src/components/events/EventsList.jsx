        ...
        <div className="bg-white rounded-lg shadow-lg flex flex-col md:flex-row p-6 w-[90%] md:w-[60%] lg:w-[45%] m-6 border border-gray-200 relative">
          ...
          <div className="flex flex-col justify-between w-full md:w-1/2 p-8">
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              ...
              <p className="text-gray-800 text-md">{singleEventView.eventName}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <h3 className="text-blue-600 text-lg font-semibold mb-2">Date:</h3>
              <p className="text-gray-800 text-md">
                {new Date(singleEventView.dateOfOrganising).toLocaleDateString()}
              </p>
            </div>
          </div>
          <div className="flex flex-col justify-between w-full md:w-1/2 p-8">
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              ...
              <p className="text-gray-800 text-md">{singleEventView.location}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <h3 className="text-blue-600 text-lg font-semibold mb-2">
                Username:
              </h3>
              <p className="text-gray-800 text-md">{singleEventView.user.name}</p>
            </div>
          </div>
