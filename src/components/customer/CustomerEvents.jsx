    ...
    <div className="w-full flex flex-wrap overflow-scroll no-scrollbar h-full justify-between">
      ...
      {events.length > 0 ? (
        events.map((event) => (
          <div
            key={event._id}
            className="bg-white border rounded-lg gap-2 shadow-lg flex flex-col p-4 md:w-[45%] m-6"
          >
            ...
            <div className="bg-blue-50 p-2 rounded-lg mb-2 h-16 flex justify-center items-center">
              <button
