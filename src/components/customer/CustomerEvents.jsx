...
const CustomerEvents = () => {
  ...
  if (loading) {
    return <div className="flex items-center justify-center h-full">Loading...</div>; // Show a loading indicator while data is being fetched
  }
  ...
  <button
    ...
    className="fixed top-4 right-4 bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition duration-300 transform hover:scale-105"
  >
    Create Event
  </button>
  {events.length > 0 ? (
    events.map((event) => (
      ...
      >
        ...
        <div className="bg-blue-50 p-2 rounded-lg mb-2 h-16 flex justify-center items-center gap-2">
          <button
            ...
            onClick={() => navigate(`/cardEdit?eventId=${event._id}`)}
          >
            Edit Pdf Cards
          </button>
          <button
            onClick={() => navigate(`/imageEdit?eventId=${event._id}`)}
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 transition duration-300"
          >
            Edit Image Cards
          </button>
          <button
            onClick={() => navigate(`/videoEdit?eventId=${event._id}`)}
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 transition duration-300"
          >
            Edit Video
          </button>
